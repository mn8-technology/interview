package ee.mn8.recap

/**
  * This simple application serves as a playground for the Scala features you can use in solving the problems.
...
object ScalaRecap extends App {
  ...
  // tail-recursive functions: VERY IMPORTANT 
